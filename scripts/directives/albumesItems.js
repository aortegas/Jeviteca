...
angular.module("jeviteca").directive("albumesItems", function(GestionFavoritos){

    return{
        restrict : "AE",
        templateUrl : "views/AlbumesItemsView.html",
        scope : {
            albumItem : "=",
            valorFavorito: "=",
            onAlbumClick: "&" // Con & asociamos un manejador del scope padre a un evento de la directiva.
        },
        ...
        link: function(scope, elemento) {
            ...
            elemento.bind("click", function() {
                ...
                scope.onAlbumClick({ idAlbum: scope.albumItem.id });
            });
        }
    };
});
